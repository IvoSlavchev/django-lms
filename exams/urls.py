...
urlpatterns = [
    ...
    url(r'^(?P<exam_id>\d+)/results$', views.view_results, name='view_results'),
    url(r'^(?P<exam_id>\d+)/result/(?P<student_id>\d+)$', views.view_participant_result, name='view_participant_result'),
